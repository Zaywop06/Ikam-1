...
const VistaDetallesPyme = ({ pymeId, volver, obtenerDetallesPyme }) => {
      ...
      {pyme ? (
        <>
          <View style={estilos.imagenContenedor}>
            <Carousel>
              {pyme.imagenes.map((imgUri, index) => (
                <Image
                  key={index}
                  source={{ uri: imgUri }}
          ...
          <ScrollView>
            <View style={estilos.detalleContenedor}>
              ...
              <Text style={estilos.descripcionTitulo}>{pyme.descripcion}</Text>
              <TouchableOpacity onPress={() => abrirEnNavegador(pyme.url_maps)}>
                <View style={estilos.descripcionContenedor}>
                  ...
                  <View style={estilos.textoContenedor}>
                    <Text style={estilos.descripcionTitulo}>Encuéntranos en</Text>
                    <Text style={estilos.descripcionDetalle}>{pyme.direccion}</Text>
                  </View>
                </View>
              </TouchableOpacity>
              <View style={estilos.descripcionContenedor}>
                ...
                <View style={estilos.textoContenedor}>
                  ...
                  <Text style={estilos.descripcionDetalle}>{pyme.horario_apertura}</Text>
                </View>
              </View>
              <TouchableOpacity
              ...
              >
                ...
                <View style={estilos.textoContenedor}>
                  ...
                  <Text style={estilos.descripcionDetalle}>{pyme.num_local}</Text>
                  <Text style={estilos.descripcionDetalle}>{pyme.num_cel}</Text>
                </View>
              </TouchableOpacity>

              <View style={estilos.contenedorRedes}>
                <Text style={estilos.descripcionRedes}>También contáctanos</Text>
...
export default VistaDetallesPyme;
